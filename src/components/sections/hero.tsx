...
export default function Hero({
  ...
  return (
    <section className="relative overflow-hidden" style={{ height: '80vh', marginTop: 0, paddingTop: 0 }}>
      ...
      <div className={`container mx-auto px-4 max-w-[1140px] relative z-10 h-full flex items-center pb-32 md:pb-20 ${showForm ? 'pt-[380px] md:pt-[220px]' : 'pt-[180px] md:pt-20'}`}>
