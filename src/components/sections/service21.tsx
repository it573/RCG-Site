...
export default function Service21({
  title = "Apoio Domiciliário, entidade licenciada pela Segurança Social (41/2023).",
              ...
              {title === "Apoio Domiciliário, entidade licenciada pela Segurança Social (41/2023)." ? (
                <>
                  ...
                  <div className="hidden md:block">
                    ...
                    <span className="text-lg font-semibold">Entidade licenciada pela Segurança Social (N.º 41/2023)</span>
                  </div>
                </>
              ) : (
                title
